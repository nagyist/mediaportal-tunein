...
namespace RadioTimePlugin
{
    ...
    public class RadioTimePluginGUI : BaseGui, ISetupForm
    {
        ...
        [SkinControl(50)] protected GUIFacadeControl listControl = null;
        [SkinControl(2)] protected GUISortButtonControl sortButton = null;
        [SkinControl(4)] protected GUIButtonControl homeButton = null;
        [SkinControl(3)] protected GUIButtonControl btnSwitchView = null;
        [SkinControl(5)] protected GUIButtonControl searchButton = null;
        [SkinControl(6)] protected GUIButtonControl presetsButton = null;
        [SkinControl(7)] protected GUIButtonControl searchArtistButton = null;
        [SkinControl(8)] protected GUIButtonControl genresButton = null;
        [SkinControl(9)] protected GUIButtonControl nowPlayingButton = null;
        [SkinControl(10)] protected GUIButtonControl randomButton = null;
        [SkinControl(11)] protected GUIButtonControl localpresetsButton = null;
        [SkinControl(51)] protected GUIImage logoImage = null;
        ...
        {
            return "yoavain (created by Dukus)";
        }
        ...
        protected override void OnPageLoad()
        {
            ...
            var msg = new GUIMessage(GUIMessage.MessageType.GUI_MSG_SETFOCUS, GetID, 0, 50, 0, 0, null);
            OnMessage(msg);
        ...
        private void g_Player_PlayBackStartedFromGUI(g_Player.MediaType type, string filename)
        {
            if (g_Player.IsVideo)
        ...
        private void DoSearchArtist()
        {
            ...
            for (var i = _setting.ArtistSearchHistory.Count; i > 0; i--)
            {
        ...
        private void DoSearch()
        {
            ...
            dlg.SetHeading(Translation.SearchHistory);
            dlg.Add(string.Format("<{0}>", Translation.NewSearch));
            for (var i = _setting.SearchHistory.Count; i > 0; i--)
            {
        ...
        {
            var itemIndex = listControl.SelectedListItemIndex;
            ...
            if (selectedItem != null)
            {
                if (selectedItem.Label != ".." && selectedItem.MusicTag != null && !selectedItem.IsFolder)
                {
                    try
                    {
                        ...
                        var station = new RadioTimeStation {Grabber = grabber};
        ...
        private void AddToLocalPreset(string presetid)
        {
            ...
            for (var i = 0; i < Settings.LocalPresetsNumber; i++)
            {
                if (_setting.PresetStations.Count > i + 1)
                {
                    ...
                    {
                        var item = new GUIListItem(_setting.PresetStations[i].Text);
        ...
        public void UpdateGui()
        {
            ...
            var view = (View) mapSettings.ViewAs;
            var sortAsc = mapSettings.SortAscending;
            switch (view)
            {
                case View.List:
